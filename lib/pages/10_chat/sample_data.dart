class ChatMessage {
  ...
  ChatMessage(this.id, this.content, this.type, this.timestamp, this.avatar,
...
List<ChatMessage> listMessage = [
  ChatMessage(
      1,
      "Anim aute aliqua culpa culpa nulla incididunt est cupidatat.",
      0,
  ...
  ChatMessage(
      9,
      "assets/stickers/bigemoji/391902150_HEARTEYE_EMOJI_400.png",
      2,
...
var reversedListMessage = List.from(listMessage.reversed);
